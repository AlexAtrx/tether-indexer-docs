...
- I want you to write/update a singe file (___TRUTH.md), which contains the 'truth' from engineering perspective. The truth including:
...
• key features that can be as good add ups
• key challenges and weak points
• key security threat if any 
• key TODO if any 
