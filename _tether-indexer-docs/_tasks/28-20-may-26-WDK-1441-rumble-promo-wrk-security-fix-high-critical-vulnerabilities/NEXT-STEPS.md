# Next steps for rumble-promo-wrk - Security - Fix High/Critical Vulnerabilities

**Ticket:** https://app.asana.com/1/45238840754660/project/1210540875949204/task/1214716439993136

## What we know
- Repo: `tetherto/rumble-promo-wrk`
- 11 open high/critical Dependabot advisories as of 2026-05-11.
...
- Live Dependabot list for `tetherto/rumble-promo-wrk` (the 11 alerts themselves).
...
1. Pull the live Dependabot list:
   `gh api repos/tetherto/rumble-promo-wrk/dependabot/alerts --paginate \
...
- **Live count for this repo:** 1 critical, 10 high (was 11 at 2026-05-11).
