...
- [ ] External system: "https://github.com/tetherto/wdk-app-node/security/dependabot" — **Need from Alex / GitHub:** the
  full list of 3 open high/critical advisories on
  `tetherto/wdk-app-node` (package, advisory id/CVE, severity, affected
  range, fixed version, transitive vs direct). Use the GitHub CLI
  (`gh api repos/tetherto/wdk-app-node/dependabot/alerts --paginate`) or
