# Next steps for wdk-app-node - Security - Fix High/Critical Vulnerabilities

**Ticket:** https://app.asana.com/1/45238840754660/project/1210540875949204/task/1214716566376368

## What we know
- Repo: `tetherto/wdk-app-node`
...
- Live Dependabot list for `tetherto/wdk-app-node` (the 3 alerts themselves).
...
1. Pull the live Dependabot list:
   `gh api repos/tetherto/wdk-app-node/dependabot/alerts --paginate \
