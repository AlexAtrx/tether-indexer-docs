# Next steps for wdk-indexer-wrk-btc - Security - Fix High/Critical Vulnerabilities

**Ticket:** https://app.asana.com/1/45238840754660/project/1210540875949204/task/1214716566892701

## What we know
- Repo: `tetherto/wdk-indexer-wrk-btc`
- 6 open high/critical Dependabot advisories as of 2026-05-11.
...
- Live Dependabot list for `tetherto/wdk-indexer-wrk-btc` (the 6 alerts themselves).
...
1. Pull the live Dependabot list:
   `gh api repos/tetherto/wdk-indexer-wrk-btc/dependabot/alerts --paginate \
...
- **Live count for this repo:** 0 critical, 6 high (was 6 at 2026-05-11).
