...
- [ ] External system: "https://github.com/tetherto/wdk-indexer-wrk-btc/security/dependabot" — **Need from Alex / GitHub:** the
  full list of 6 open high/critical advisories on
  `tetherto/wdk-indexer-wrk-btc` (package, advisory id/CVE, severity, affected
  range, fixed version, transitive vs direct). Use the GitHub CLI
  (`gh api repos/tetherto/wdk-indexer-wrk-btc/dependabot/alerts --paginate`) or
...
- [ ] Alert count drift: the description fixes the count at
  "6 open at 2026-05-11". Today is 2026-05-20, so the live
