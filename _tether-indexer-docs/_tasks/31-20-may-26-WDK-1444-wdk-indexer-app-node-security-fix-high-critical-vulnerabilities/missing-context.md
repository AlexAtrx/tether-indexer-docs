...
- [ ] External system: "https://github.com/tetherto/wdk-indexer-app-node/security/dependabot" — **Need from Alex / GitHub:** the
  full list of 3 open high/critical advisories on
  `tetherto/wdk-indexer-app-node` (package, advisory id/CVE, severity, affected
  range, fixed version, transitive vs direct). Use the GitHub CLI
  (`gh api repos/tetherto/wdk-indexer-app-node/dependabot/alerts --paginate`) or
...
- [ ] Alert count drift: the description fixes the count at
  "3 open at 2026-05-11". Today is 2026-05-20, so the live
