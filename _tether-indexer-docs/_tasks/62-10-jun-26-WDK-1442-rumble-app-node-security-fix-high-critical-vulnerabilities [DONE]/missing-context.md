...
- [ ] External system: "https://github.com/tetherto/rumble-app-node/security/dependabot" — **Need from Alex / GitHub:** the
  full list of 4 open high/critical advisories on
  `tetherto/rumble-app-node` (package, advisory id/CVE, severity, affected
  range, fixed version, transitive vs direct). Use the GitHub CLI
  (`gh api repos/tetherto/rumble-app-node/dependabot/alerts --paginate`) or
...
- [ ] Alert count drift: the description fixes the count at
  "4 open at 2026-05-11". Today is 2026-05-20, so the live
