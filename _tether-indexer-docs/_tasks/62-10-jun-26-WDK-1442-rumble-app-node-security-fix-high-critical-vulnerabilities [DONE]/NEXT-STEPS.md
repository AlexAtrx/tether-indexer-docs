# Next steps for rumble-app-node - Security - Fix High/Critical Vulnerabilities

**Ticket:** https://app.asana.com/1/45238840754660/project/1210540875949204/task/1214716461893028

## What we know
- Repo: `tetherto/rumble-app-node`
- 4 open high/critical Dependabot advisories as of 2026-05-11.
...
- Live Dependabot list for `tetherto/rumble-app-node` (the 4 alerts themselves).
...
1. Pull the live Dependabot list:
   `gh api repos/tetherto/rumble-app-node/dependabot/alerts --paginate \
...
- **Live count for this repo:** 0 critical, 4 high (was 4 at 2026-05-11).
